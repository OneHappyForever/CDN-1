...
返回数据如下图 :
![用户歌单](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/%E7%94%A8%E6%88%B7%E6%AD%8C%E5%8D%95.png)
...
返回数据如下图 :
![歌单详情](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/%E6%AD%8C%E5%8D%95%E8%AF%A6%E6%83%85.png)
...
返回数据如下图 :
![音乐 url](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/%E9%9F%B3%E4%B9%90%20url.png)
...
返回数据如下图 :
![搜索音乐](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/%E6%90%9C%E7%B4%A2.png)
...
返回数据如下图 :
![获取歌词](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/%E6%AD%8C%E8%AF%8D.png)
...
返回数据如下图 :
![获取评论](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/comment.png)
...
返回数据如下图 :
![获取歌曲详情](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/songDetail.png)
...
返回数据如下图 :
![获取专辑内容](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/%E4%B8%93%E8%BE%91.png)
...
返回数据如下图 :
![获取歌手单曲](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/artists.png)
...
返回数据如下图 :
![获取专辑内容](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/artist_album.png)
...
返回数据如下图 :
![每日推荐歌单](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/%E6%8E%A8%E8%8D%90%E6%AD%8C%E5%8D%95.png)
...
返回数据如下图 :
![每日推荐歌曲](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/%E6%8E%A8%E8%8D%90%E6%AD%8C%E6%9B%B2.png)
...
![私人 FM](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/personal_fm.png)
...
![签到成功](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/signinSuccess.png)

![签到失败](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/signinError.png)
...
![喜欢成功](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/like.png)

喜欢成功则返回数据的 code 为 200, 其余为失败

![喜欢成功截图](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/likeSuccess.png)
...
![移除成功](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/fm_trash.png)
...
![热门歌手](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/top_artists.png)
...
![mv 数据](https://cdn.jsdelivr.net/gh/Binaryify/NeteaseCloudMusicApi@master/static/mv.png)
